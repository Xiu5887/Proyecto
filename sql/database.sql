...
('Matemática II', 'MAT-02', 2),
('Álgebra Lineal', 'AL-02', 2),
('Seminario II', 'SEM-02', 2),
('Defensa Integral de la Nación II', 'DIN-02', 2),
-- Semestre 3
('Física II', 'FIS-03', 3),
('Matemática III', 'MAT-03', 3),
('Probabilidades y Estadística', 'PE-03', 3),
('Programación', 'PROG-03', 3),
('Sistemas Administrativos', 'SA-03', 3),
('Defensa Integral de la Nación III', 'DIN-03', 3),
-- Semestre 4
('Teoría de los Sistemas', 'TS-04', 4),
('Cálculo Numérico', 'CN-04', 4),
('Lógica Matemática', 'LM-04', 4),
('Lenguajes de Programación I', 'LP-04', 4),
('Procesamiento de Datos', 'PD-04', 4),
('Sistemas de Producción', 'SP-04', 4),
('Defensa Integral de la Nación IV', 'DIN-04', 4),
-- Semestre 5
('Teoría de Grafos', 'TG-05', 5),
('Lenguajes de Programación II', 'LP-05', 5),
('Investigación de Operaciones', 'IO-05', 5),
('Circuitos Lógicos', 'CL-05', 5),
('Análisis de Sistemas', 'AS-05', 5),
('Bases de Datos', 'BD-05', 5),
('Defensa Integral de la Nación V', 'DIN-05', 5),
-- Semestre 6
('Optimización No Lineal', 'ONL-06', 6),
('Lenguajes de Programación III', 'LP-06', 6),
('Procesos Estocásticos', 'PE-06', 6),
